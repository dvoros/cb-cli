...
// WithEnvironmentID adds the environmentID to the delete ldap config v1 params
func (o *DeleteLdapConfigV1Params) WithEnvironmentID(environmentID *string) *DeleteLdapConfigV1Params {
	o.SetEnvironmentID(environmentID)
	return o
}

// SetEnvironmentID adds the environmentId to the delete ldap config v1 params
func (o *DeleteLdapConfigV1Params) SetEnvironmentID(environmentID *string) {
